...
export default {
  ...
  methods: {
    ...
    loadata() {
      const params = {
        proposalPlan: {
          // bookId: "bb891a9988304dab80bc262d9c143986"
          bookId: this.bookId
        }
      };
      utils.http
        ...
        .then(res => {
          ...
          //分红比例
          this.benifitList = res.proposalViewDto.benifitList;
          //利益演示
          console.log(this.benifitList);
