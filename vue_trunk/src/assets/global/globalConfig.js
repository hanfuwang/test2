...
import { getClientHeight, isIphoneFullScreen } from "@/utils/modules/ui";
...
const globalConfig = {
  ...
  argeeMentUrl: process.env.VUE_APP_OPEN_ARGEEMENT_URL, //客户委托代收业务协议pdf地址
