      ...
      if (content == "productRSType") {
        ...
        this.productRSType.product.map(ele => {
          if (ele.attrValue === item.attrValue) {
            ...
            this.attrName = "product_type_lifestage";
            this.init("0");
        ...
        this.productBZType.product.map(ele => {
          if (ele.attrValue === item.attrValue) {
            ele.selected = true;
            this.attrValue = item.attrValue;
            this.attrName = "product_type_category";
            this.init("0");
            this.modalStatus = false;
          } else {
            ele.selected = false;
    ...
    init(num) {
      ...
      if (!flag) {
        ...
        const params = {
          ...
          infoId: this.userInfo.weChatAgenctDTO.infoId, //规划师infoId(Y)
